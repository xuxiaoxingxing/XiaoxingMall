...
import com.xiaoxing.mall.adapter.GuideViewPagerAdapter;
import com.xiaoxing.mvp_core.base.CoreBaseActivity;

import java.util.ArrayList;
import java.util.List;

import static com.xiaoxing.mall.MallConstants.FIRST_OPEN;

/**
 * 引导页面
 */
public class WelcomeGuideActivity extends CoreBaseActivity implements View.OnClickListener {
    // 引导页图片资源
    ...
    public void onPause() {
        ...
        sHelper.putBoolean(FIRST_OPEN, false);
        finish();
    }
