package com.xiaoxing.mvp_core.view.xtablayout;
...
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                RectF r2 = new RectF();
                r2.left = mIndicatorLeft;
                r2.right = mIndicatorRight;
                r2.top = getHeight() - mSelectedIndicatorHeight;
                r2.bottom = getHeight();
                canvas.drawRoundRect(r2, 5, 5, mSelectedIndicatorPaint);
            }
        }
    }
